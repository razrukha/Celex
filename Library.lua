...
local Library, Utility, Flags = {
    ...
    Presets = {
        Themes = {
            Celex = {
                ["Light Contrast"] = Color3.fromRGB(23, 104, 167),
                ["Dark Contrast"] = Color3.fromRGB(39, 80, 115),
                ["Arrow Color"] = Color3.fromRGB(39, 80, 115),
                ...
                ["Lighter Text"] = Color3.fromRGB(226, 226, 226),
        ...
        function Library.Objects:Scroll(Parent, Gradients, Offset, Bottom, Top, Size, Index)
            ...
            do -- Connections
                SizeConnection = Utility.General:Connect(Objects["Content"]:GetPropertyChangedSignal("AbsoluteSize"), function()
                    ...
                    Objects["Bar"].Visible = (Objects["List"].AbsoluteContentSize.Y > Objects["List"].AbsoluteSize.Y)
                end)
                --
